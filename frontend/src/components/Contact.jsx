      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
        ...
        <div>
          ...
          <div className="space-y-5">
            ...
            {/* Email */}
            <a href={`mailto:${profileDetails.email}`} className="flex items-center gap-4 group">
              ...
              <span className="text-gray-700 font-medium group-hover:text-gray-900 transition-colors">{profileDetails.email}</span>
            </a>

            {/* Phone */}
            <a href={`tel:${profileDetails.phone.replace(/\s+/g, '')}`} className="flex items-center gap-4 group">
              <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center group-hover:bg-gray-900 group-hover:text-white transition-all duration-300">
              ...
              <span className="text-gray-700 font-medium group-hover:text-gray-900 transition-colors">{profileDetails.phone}</span>
            </a>

            {/* Socials Row */}
            <div className="flex items-center gap-4 pt-4">
              {/* Behance */}
              <a href={socialLinks.behance} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center hover:bg-blue-600 hover:text-white text-gray-600 transition-all duration-300">
              ...
              {/* Instagram */}
              <a href={socialLinks.instagram} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center hover:bg-gradient-to-tr hover:from-yellow-400 hover:via-pink-500 hover:to-purple-600 hover:text-white text-gray-600 transition-all duration-300">
              ...
              {/* LinkedIn */}
              <a href={socialLinks.linkedin} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center hover:bg-blue-700 hover:text-white text-gray-600 transition-all duration-300">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {submitted && (
              <div className="bg-green-50 border border-green-200 text-green-800 px-4 py-3 rounded-lg text-sm font-medium flex items-center gap-2 animate-scale-in">
                <span>✓</span>
                Thank you! {profileDetails.firstName} will get back to you shortly.
              </div>
            )}
