...
export default function Contact() {
  ...
  return (
    <section id="contact" className="w-full bg-white text-black pt-16 md:pt-58 pb-8 md:pb-5 relative overflow-hidden">
      ...
      {/* Desktop GIF (absolute to the left corner of the screen) */}
      <div className="hidden md:block absolute bottom-0 left-0 w-[360px] lg:w-[456px] z-10">
        <img src={contactImg} alt="Contact Hiiii" className="w-full h-auto object-contain object-left-bottom" />
      </div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative">
        ...
        {/* Mobile GIF */}
        <div className="md:hidden mt-12 w-[440px] max-w-full -ml-2 relative z-10">
