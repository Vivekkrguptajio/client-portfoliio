      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
        ...
        <div>
          ...
          <div className="space-y-5">
            ...
            {/* Email */}
            <a href="mailto:ranjeet@example.com" className="flex items-center gap-4 group">
              ...
              <span className="text-gray-700 font-medium group-hover:text-gray-900 transition-colors">ranjeet@example.com</span>
            </a>
            ...
            <a href="tel:+919876543210" className="flex items-center gap-4 group">
              ...
              <span className="text-gray-700 font-medium group-hover:text-gray-900 transition-colors">+91 98765 43210</span>
            </a>
            ...
            <div className="flex items-center gap-4 pt-4">
              ...
              {/* LinkedIn */}
              <a href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center hover:bg-blue-700 hover:text-white text-gray-600 transition-all duration-300">
